...
- 修复：点击编辑区域后，文档面包屑被思源自动折叠的问题；；

> 我今天只走这么远，只有明天才能为我指明方向。

### v2.0.2 (2026年9月2日)

- 改进：适配思源v3.8.2默认SVG图标；
- 修复：面包屑图标设置为不显示，但可能仍在显示的问题；

> 大部分的人多少都希望受到别人的赞赏。但是做好事做大事太困难了。那最简单的方法是什么呢？谴责做坏事的人就好了。
>
> _湊佳苗《告白》（丁世佳 译）_

### v2.0.2-alpha1 (2026年8月30日)

- 改进：适配思源v3.8.2默认SVG图标；
- 修复：面包屑图标设置为不显示，但可能仍在显示的问题；

> 事实上，我很怕我做不到。这种担忧与日俱增。

### v2.0.1 (2026年8月29日)

- 改进：面包屑文档名长度应用修改；

> 从这个版本开始，开发者可能会在更新日志中胡言乱语或引用句子。
