...
log("read token " + SIYUAN_API_TOKEN)
let POST_HEADER = {
    "Content-Type": "application/json",
}
if (SIYUAN_API_TOKEN) {
    POST_HEADER["Authorization"] = `Token ${SIYUAN_API_TOKEN}`
}
...
if (fs.existsSync(targetPath)) {
    ...
    fs.writeFileSync(`${process.cwd()}\\scripts\\devInfo.json`, JSON.stringify(devInfo), 'utf-8');
